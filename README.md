...
<ul>
    ...
    <li>Trying to create a web panel (in Next.js) that sends requests to a backend app (that uses Django), in order to create and manage game servers with a few clicks.</li>
